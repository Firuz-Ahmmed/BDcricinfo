<?php
$playerserr=$runserr=$wicketerr=$rankerr=$debuerr=$roleerr="";
$playersr=$runsr=$wicketr=$rankr=$debur=$roler="";
if($_SERVER["REQUEST_METHOD"]=="POST")
{
    ...
    if($error==0)
    {
        ...
        $s="insert into players_info (player_name,odi_runs,odi_wicket,odi_rank,debut_odi,players_role) values ('".$_POST["players"]."','".$_POST["runs"]."','".$_POST["wicket"]."','".$_POST["rank"]."','".$_POST["debu"]."','".$_POST["role"]."')";
        if(mysqli_query($con, $s))
        {
            echo 'created successfully'<a href="home.php">Click here To Go HOME</a>;
        }
        else
        {
